	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="footer-text-area">
			...
			<div class="theme-info">
				<a href="<?php echo esc_url( esc_html__( 'https://null24.Net/', 'NULL24' ) ); ?>"><?php printf( esc_html__( 'Proudly powered by %s', 'listable' ), 'WordPress' ); ?></a>
				<span class="sep"> <?php _e( 'and', 'listable' ) ?> </span>
				<?php printf( esc_html__( '%1$s by %2$s.', 'listable' ), '<a href="http://themeforest.net/item/listable-a-friendly-directory-wordpress-theme/13398377?ref=pixelgrade" rel="theme">Listable</a>', '<a href="https://NULL24.NET/" rel="designer">NULL24</a>' ); ?>
			</div>
		</div>
	</footer><!-- #colophon -->
</div><!-- #page -->
