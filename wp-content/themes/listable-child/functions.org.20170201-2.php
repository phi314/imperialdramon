...
function unleashed_billing_fields( $fields ) {
    $US_fields['billing_country']                = $fields['billing_country'];
    ...
    $US_fields['billing_state']                  = $fields['billing_state'];
    ...
    $US_fields['billing_city']					= $fields['billing_city'];
    $US_fields['billing_city']['class']			= array( 'form-row-wide', 'address-field', 'update_totals_on_change' );
...
function unleashed_shipping_fields( $fields ) {
    $US_fields['shipping_country']              = $fields['shipping_country'];
    ...
    $US_fields['shipping_state']                = $fields['shipping_state'];
...
function unleashed_checkout_fields( $fields ) {
    $US_fields['billing']['billing_country']                = $fields['billing']['billing_country'];
    ...
    $US_fields['billing']['billing_state']                  = $fields['billing']['billing_state'];
    ...
    $US_fields['shipping']['shipping_country']                = $fields['shipping']['shipping_country'];
    ...
    $US_fields['shipping']['shipping_state']                = $fields['shipping']['shipping_state'];
