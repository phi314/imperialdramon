...
class WC_Social_Login extends SV_WC_Plugin {
	...
	/**
	 * Return the opauth class instance
	 *
	 * @since 1.8.0
	 * @return \WC_Social_Login_Opauth
	 */
	public function get_opauth_instance() {
		return $this->opauth;
	}
	...
	public function &__get( $name ) {
		...
		switch ( $name ) {
			...
			case 'opauth':
				...
				/* @deprecated since 1.8.0 */
				_deprecated_function( 'wc_social_login()->opauth', '1.8.0', 'wc_social_login()->get_opauth_instance()' );
				return $this->get_opauth_instance();
